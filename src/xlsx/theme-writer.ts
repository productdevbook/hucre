// ── Theme Writer ─────────────────────────────────────────────────────
// Generates xl/theme/theme1.xml — the standard Office theme color scheme.

/**
 * Generate a minimal but valid xl/theme/theme1.xml with the standard
 * Office color scheme. This ensures theme color references in styles
 * can be resolved when reading the file back.
 */
export function writeThemeXml(): string {
